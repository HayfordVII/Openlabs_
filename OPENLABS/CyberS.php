...
<section class="hero" id="home">
    ...
    if  ($fetch['userName'] == 'Employer') {?>
        <section class="container">
            ...
            <?php
            $query = "SELECT * FROM users WHERE userType = 'Intern' AND userCourse ='Cybersecurity';";
    ...
    <!-- For Interns -->
        ...
        <section id="CyberSection">
            <?php
            $query = "SELECT * FROM users WHERE userType ='Employer' AND userCourse ='Cybersecurity';";
            $query_run = mysqli_query($conn, $query);
            ...
            if ($check_faculty) {
                while($row = mysqli_fetch_array($query_run))
                {
                    ...
                    <?php
                        if  ($fetch['userWorkstation'] == 'Home') {?>
                            <div class="card mt 5" style="border-left-color: #53C5F2;">
                        <?php } else if($fetch['userWorkstation'] == 'Office') {?>
                            <div class="card mt 5" style="border-left-color: #86C664;">
                        <?php } else if($fetch['userWorkstation'] == 'Both') {?>   
                            <div class="card mt 5" style="border-left-color: #FF5A5A;">
                        <?php } ?>
                            ...
                            <div class="row">
                                ...
                                if($fetch['userPic'] == ''){
                                    ...
                                    echo '<img src="uploaded_img/'.$fetch['userPic'].' style="height:30px;object-fit: contain;border-radius:50px; ">';
                                }
                                ?>
