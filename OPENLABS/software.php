...
<section class="hero" id="home">
    ...
    <section class="services " id="services" >
        <div class="max-width">
            <h2 class="title">SOFTWARE DEV</h2>
        </div>
    </section>
    ...
    if  ($fetch['userName'] == 'Employer') {?>
        <section class="container">
            ...
            <?php
            $query = "SELECT * FROM users WHERE userType = 'Intern' AND userCourse ='Software Dev';";
    ...
    <!-- For Interns -->
        ...
        <section id="CyberSection">
            <?php
            $query = "SELECT * FROM users WHERE userType ='Employer' AND userCourse ='Software Dev';";
            $query_run = mysqli_query($conn, $query);
